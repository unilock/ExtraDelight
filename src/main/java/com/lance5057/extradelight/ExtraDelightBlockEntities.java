...
public class ExtraDelightBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<SpiceRackEntity>> SPICE_RACK = TILES
			.register("spice_rack", () -> BlockEntityType.Builder
					...
					.build(null));
	public static final RegistryObject<BlockEntityType<SpiceRackEntity>> SPICE_RACK_FULL = TILES
...
//					.build(null));
	...
	public static final RegistryObject<BlockEntityType<MortarBlockEntity>> MORTAR = TILES.register(
			"mortar",
