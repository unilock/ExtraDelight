...
public class ExtraDelightWorldGen {
	...
	public static final ResourceKey<StructureSet> STRUCTURE_SET = ResourceKey.create(
	...
	public static final ResourceLocation DOLL_CIRCLE = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "doll_circle");
	public static final ResourceLocation DOLL_CIRCLE1 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "doll_circle1");
	public static final ResourceLocation DOLL_CIRCLE2 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "doll_circle2");
	public static final ResourceLocation DOLL_CIRCLE3 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "doll_circle3");
	public static final ResourceLocation DOLL_CIRCLE4 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "doll_circle4");
	public static final ResourceLocation FOUNTAIN = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "fountain");
	public static final ResourceLocation HAUNTEDHOUSE = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "hauntedhouse");
	public static final ResourceLocation PUMPKIN_PATCH2 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "pumpkin_patch2");
	public static final ResourceLocation PUMPKIN_PATCH3 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "pumpkin_patch3");
	public static final ResourceLocation PUMPKIN_PATCH4 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "pumpkin_patch4");
	public static final ResourceLocation PUMPKIN_PATCH5 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "pumpkin_patch5");
	public static final ResourceLocation PUMPKIN_PILE1 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "pumpkin_pile1");
	public static final ResourceLocation RAIL_STOP = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "rail_stop");
	public static final ResourceLocation SACRIFICE = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "sacrifice");
	public static final ResourceLocation SACRIFICE2 = ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "sacrifice2");
