...
//	};
	...
	public static final RegistryObject<BlockItem> SHEET = ITEMS.register("sheet",
			() -> new BlockItem(ExtraDelightBlocks.SHEET_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> TRAY = ITEMS.register("tray",
			() -> new BlockItem(ExtraDelightBlocks.TRAY_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> LOAF_PAN = ITEMS.register("loaf_pan",
			() -> new BlockItem(ExtraDelightBlocks.LOAF_PAN_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> PIE_DISH = ITEMS.register("pie_dish",
			() -> new BlockItem(ExtraDelightBlocks.PIE_DISH_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> SQUARE_PAN = ITEMS.register("square_pan",
			() -> new BlockItem(ExtraDelightBlocks.SQUARE_PAN_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> BAKING_STONE = ITEMS.register("baking_stone",
			() -> new BlockItem(ExtraDelightBlocks.BAKING_STONE_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> MUFFIN_TIN = ITEMS.register("muffin_tin",
			() -> new BlockItem(ExtraDelightBlocks.MUFFIN_TIN_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> SERVING_POT = ITEMS.register("serving_pot",
			() -> new BlockItem(ExtraDelightBlocks.SERVING_POT_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> SERVING_PAN = ITEMS.register("serving_pan",
			() -> new BlockItem(ExtraDelightBlocks.SERVING_PAN_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> SERVING_BOWL = ITEMS.register("serving_bowl",
...
//			() -> new Item(new Item.Properties().food(FoodVanilla.CUPCAKE)));
	...
	public static final RegistryObject<Item> CHOCOLATE_CUSTARD = ITEMS.register("chocolate_custard",
			() -> new ConsumableItem(
					new Item.Properties().food(EDFoods.CUSTARD).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16)));
	public static final RegistryObject<Item> PUMPKIN_CUSTARD = ITEMS.register("pumpkin_custard", () -> new ConsumableItem(
			new Item.Properties().food(EDFoods.CUSTARD).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16)));
	public static final RegistryObject<Item> HONEY_CUSTARD = ITEMS.register("honey_custard", () -> new ConsumableItem(
			new Item.Properties().food(EDFoods.CUSTARD).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16)));
	public static final RegistryObject<Item> APPLE_CUSTARD = ITEMS.register("apple_custard", () -> new Item(
			new Item.Properties().food(EDFoods.CUSTARD).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16)));
...
//			() -> new Item(new Item.Properties().food(EDFoods.JAM).craftRemainder(Items.GLASS_BOTTLE)));
	...
	// Feasts
	public static final RegistryObject<BlockItem> SALISBURY_STEAK_FEAST_ITEM = ITEMS.register(
	...
	// Stews
	public static final RegistryObject<BowlFoodItem> PORK_STEW = ITEMS.register("pork_stew", () -> new BowlFoodItem(
			new Item.Properties().food(EDFoods.PORK_STEW).craftRemainder(Items.BOWL).stacksTo(16)));
	public static final RegistryObject<BowlFoodItem> LAMB_STEW = ITEMS.register("lamb_stew", () -> new BowlFoodItem(
			new Item.Properties().food(EDFoods.LAMB_STEW).craftRemainder(Items.BOWL).stacksTo(16)));
	public static final RegistryObject<BowlFoodItem> CHICKEN_STEW = ITEMS.register("chicken_stew", () -> new BowlFoodItem(
	...
	public static final RegistryObject<BowlFoodItem> CURRY_RICE = ITEMS.register("curry_rice", () -> new BowlFoodItem(
	...
	public static final RegistryObject<BowlFoodItem> LIVER_ONIONS = ITEMS.register("liver_onions", () -> new BowlFoodItem(
	...
	public static final RegistryObject<BowlFoodItem> POT_ROAST = ITEMS.register("potroast", () -> new BowlFoodItem(
	...
	public static final RegistryObject<BowlFoodItem> MEAT_LOAF = ITEMS.register("meatloaf", () -> new BowlFoodItem(
			new Item.Properties().food(EDFoods.MEAT_LOAF_SERVING).craftRemainder(Items.BOWL).stacksTo(16)));
	public static final RegistryObject<Item> MEAT_LOAF_SANDWICH = ITEMS.register("meatloaf_sandwich", () -> new Item(
	...
	public static final RegistryObject<Item> PULLED_PORK_SANDWICH = ITEMS.register("pulled_pork_sandwich", () -> new Item(
	...
	public static final RegistryObject<BowlFoodItem> JELLY_ORANGE = ITEMS.register("jelly_orange", () -> new BowlFoodItem(
			new Item.Properties().food(EDFoods.JELLY_SERVING).craftRemainder(Items.BOWL).stacksTo(16)));
	...
	public static final RegistryObject<BowlFoodItem> JELLY_LIGHT_BLUE = ITEMS.register("jelly_light_blue",
			() -> new BowlFoodItem(
					new Item.Properties().food(EDFoods.JELLY_SERVING).craftRemainder(Items.BOWL).stacksTo(16)));
	public static final RegistryObject<BowlFoodItem> JELLY_YELLOW = ITEMS.register("jelly_yellow", () -> new BowlFoodItem(
			new Item.Properties().food(EDFoods.JELLY_SERVING).craftRemainder(Items.BOWL).stacksTo(16)));
	...
	public static final RegistryObject<BowlFoodItem> JELLY_CYAN = ITEMS.register("jelly_cyan", () -> new BowlFoodItem(
			new Item.Properties().food(EDFoods.JELLY_SERVING).craftRemainder(Items.BOWL).stacksTo(16)));
	public static final RegistryObject<BowlFoodItem> JELLY_PURPLE = ITEMS.register("jelly_purple", () -> new BowlFoodItem(
			new Item.Properties().food(EDFoods.JELLY_SERVING).craftRemainder(Items.BOWL).stacksTo(16)));
	...
	// Pasta
	public static final RegistryObject<Item> MACARONI = ITEMS.register("macaroni", () -> new Item(new Item.Properties()));
...
//			() -> new ShuckableCorn(MiscLootTables.SHUCKED_CORN, new Item.Properties()));
	...
	public static final RegistryObject<Item> ROASTED_PUMPKIN_SEEDS = ITEMS.register("roasted_pumpkin_seeds",
			() -> new Item(new Item.Properties().food(EDFoods.EDIBLE_SEEDS)));
	public static final RegistryObject<CornSilkTeaItem> TEA = ITEMS.register("tea",
...
//			() -> new CornSilkTeaItem(new Item.Properties()));
	...
	public static final RegistryObject<BlockItem> TAP = ITEMS.register("tap",
	...
	public static final RegistryObject<Item> GREEN_COFFEE = ITEMS.register("green_coffee",
	...
	public static final RegistryObject<Item> OIL_FLUID_BOTTLE = ITEMS.register("oil_fluid_bottle",
	...
	public static final RegistryObject<Item> VINEGAR_FLUID_BUCKET = ITEMS.register("vinegar_fluid_bucket",
			() -> new BucketItem(ExtraDelightFluids.VINEGAR.FLUID,
					new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
	public static final RegistryObject<Item> VINEGAR_FLUID_BOTTLE = ITEMS.register("vinegar_fluid_bottle",
			() -> new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).stacksTo(16)));
	...
	public static final RegistryObject<Item> GRAVY_FLUID_BUCKET = ITEMS.register("gravy_fluid_bucket",
			() -> new BucketItem(ExtraDelightFluids.GRAVY.FLUID,
					new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
	public static final RegistryObject<Item> GRAVY_FLUID_BOTTLE = ITEMS.register("gravy_fluid_bottle",
			() -> new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).stacksTo(16)));
	...
	public static final RegistryObject<Item> CUSTARD_FLUID_BUCKET = ITEMS.register("custard_fluid_bucket",
	...
	public static final RegistryObject<BlockItem> KEG = ITEMS.register("keg_item",
			() -> new BlockItem(ExtraDelightBlocks.KEG.get(), new Item.Properties()));

	public static final RegistryObject<BlockItem> FRUIT_LOG = ITEMS.register("fruit_log",
			() -> new BlockItem(ExtraDelightBlocks.FRUIT_LOG.get(), new Item.Properties()) {
				public int getBurnTime(ItemStack itemStack, @Nullable RecipeType<?> recipeType) {
					return 300;
				}
			});
	public static final RegistryObject<BlockItem> STRIPPED_FRUIT_LOG = ITEMS.register("stripped_fruit_log",
			() -> new BlockItem(ExtraDelightBlocks.STRIPPED_FRUIT_LOG.get(), new Item.Properties()) {
				public int getBurnTime(ItemStack itemStack, @Nullable RecipeType<?> recipeType) {
					return 300;
				}
			});
	public static final RegistryObject<DoubleHighBlockItem> FRUIT_DOOR = ITEMS.register("fruit_door",
			() -> new DoubleHighBlockItem(ExtraDelightBlocks.FRUIT_DOOR.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> FRUIT_PLANKS = ITEMS.register("fruit_planks",
			() -> new BlockItem(ExtraDelightBlocks.FRUIT_PLANKS.get(), new Item.Properties()) {
				public int getBurnTime(ItemStack itemStack, @Nullable RecipeType<?> recipeType) {
					return 300;
				}
			});
	public static final RegistryObject<BlockItem> FRUIT_FENCE = ITEMS.register("fruit_fence",
			() -> new BlockItem(ExtraDelightBlocks.FRUIT_FENCE.get(), new Item.Properties()) {
				public int getBurnTime(ItemStack itemStack, @Nullable RecipeType<?> recipeType) {
					return 300;
				}
			});
	public static final RegistryObject<BlockItem> FRUIT_FENCE_GATE = ITEMS.register("fruit_fence_gate",
			() -> new BlockItem(ExtraDelightBlocks.FRUIT_FENCE_GATE.get(), new Item.Properties()) {
				public int getBurnTime(ItemStack itemStack, @Nullable RecipeType<?> recipeType) {
					return 300;
				}
			});
	public static final RegistryObject<BlockItem> FRUIT_STAIRS = ITEMS.register("fruit_stairs",
			() -> new BlockItem(ExtraDelightBlocks.FRUIT_STAIRS.get(), new Item.Properties()) {
				public int getBurnTime(ItemStack itemStack, @Nullable RecipeType<?> recipeType) {
					return 300;
				}
			});
	public static final RegistryObject<BlockItem> FRUIT_TRAPDOOR = ITEMS.register("fruit_trapdoor",
			() -> new BlockItem(ExtraDelightBlocks.FRUIT_TRAPDOOR.get(), new Item.Properties()) {
				public int getBurnTime(ItemStack itemStack, @Nullable RecipeType<?> recipeType) {
					return 300;
				}
			});
	public static final RegistryObject<BlockItem> FRUIT_CABINET = ITEMS.register("fruit_cabinet",
			() -> new BlockItem(ExtraDelightBlocks.FRUIT_CABINET.get(), new Item.Properties()) {
				public int getBurnTime(ItemStack itemStack, @Nullable RecipeType<?> recipeType) {
					return 300;
				}
			});
	public static final RegistryObject<BlockItem> FRUIT_SLAB = ITEMS.register("fruit_slab",
	...
	public static final RegistryObject<Item> HAZELNUT = ITEMS.register("hazelnut", () -> new Item(new Item.Properties()));
	public static final RegistryObject<BlockItem> HAZELNUT_LEAVES = ITEMS.register("hazelnut_leaves",
	...
	public static final RegistryObject<Item> CHILI = ITEMS.register("chili", () -> new Item(new Item.Properties()));

	public static final RegistryObject<BlockItem> MILK_CHOCOLATE_BLOCK = ITEMS.register("milk_chocolate_block",
			() -> new BlockItem(ExtraDelightBlocks.MILK_CHOCOLATE_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> DARK_CHOCOLATE_BLOCK = ITEMS.register("dark_chocolate_block",
			() -> new BlockItem(ExtraDelightBlocks.DARK_CHOCOLATE_BLOCK.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> WHITE_CHOCOLATE_BLOCK = ITEMS.register("white_chocolate_block",
			() -> new BlockItem(ExtraDelightBlocks.WHITE_CHOCOLATE_BLOCK.get(), new Item.Properties()));
	
	public static final RegistryObject<Item> JAR = ITEMS.register("jar", () -> new Item(new Item.Properties()));
}
